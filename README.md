...
Для примера, все шаги установки сделаны в [тестовом проекте](https://github.com/liquetsoft/fias-example), который реализует простейшее REST API с использованием [API platform](https://api-platform.com/).
